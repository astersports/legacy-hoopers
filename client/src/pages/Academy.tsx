      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <p className="text-white/60 text-base mt-4 max-w-lg">
            The expectations, structure, and development system that define every Aster Sports AAU player.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <div>
              ...
              <ul className="space-y-3">
                {["Arrive on time, ready to compete", "Respect all coaches, teammates, and opponents", "Give maximum effort in every drill and rep", "Accept coaching without excuses", "Represent Aster Sports AAU with class — on and off the court"].map((item, i) => (
