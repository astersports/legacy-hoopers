          ...
          <div className="lg:col-span-3">
            <div className="rounded-2xl border border-border bg-card p-8 shadow-sm">
              ...
              <div className="mt-5 space-y-4 leading-relaxed text-muted-foreground">
                <p>
                  Coach Kenny founded Legacy Hoopers with a simple conviction: youth basketball coaching should
                ...
                <p>
                  Before founding Legacy Hoopers, Coach Kenny spent years studying what separates elite
                ...
                <p>
                  That's what Legacy Hoopers delivers. Not a rec league with better jerseys — a genuine academy
