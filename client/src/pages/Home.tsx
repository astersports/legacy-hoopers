    ...
    <div>
      ...
      <section className="border-b border-border bg-gradient-to-b from-secondary/50 to-background">
        <div className="container py-16 sm:py-20">
          ...
          <h1 className="mt-4 max-w-3xl text-4xl font-extrabold leading-[1.05] tracking-tight text-foreground sm:text-6xl">
          ...
          <div className="mt-12 grid grid-cols-2 gap-3 sm:max-w-2xl sm:grid-cols-4">
            {[
