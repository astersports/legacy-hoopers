...
const timeline = [
  { year: "2022", title: "Founded", desc: "Aster Sports AAU launches with a single 10U team in Westchester County." },
    ...
    <div>
      ...
      <section className="container py-14">
        <div className="mx-auto max-w-3xl rounded-2xl border border-border bg-card p-8 shadow-sm">
          <h2 className="text-2xl font-extrabold tracking-tight text-foreground">Why Aster Sports AAU?</h2>
          <div className="mt-5 space-y-4 leading-relaxed text-muted-foreground">
            ...
            <p>
              <span className="font-semibold text-foreground">Aster Sports AAU is different.</span> We operate as
